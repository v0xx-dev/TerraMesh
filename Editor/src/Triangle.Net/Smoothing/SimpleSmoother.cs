...
namespace TriangleNet.Smoothing
{
    ...
    public class SimpleSmoother : ISmoother
    {
        ...
        private void Centroid(Face face, out float x, out float y)
        {
            ...
            var edge = face.Edge;
            UnityEngine.Debug.Log("Face: " + face==null?"null":face.ID.ToString());
            UnityEngine.Debug.Log("Edge: " + edge==null?"null":edge.ID.ToString());
            UnityEngine.Debug.Log("Edge: " + edge.ID);
